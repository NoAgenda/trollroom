<template>
	<div class="inline-player">
		...
		<div v-if="playing" class="ip-footer">
			<button class="volume volume-high" aria-label="Current volume: 100%" />
...
export default defineComponent({
	...
	setup(props) {
		...
		const streamUrl = props.music
			? "https://listen.noagendastream.com/v4vmusic?type=.mp3"
			: "https://listen.noagendastream.com/noagenda?type=.mp3";
		...
		const togglePlaying = () =>
			Player.playing && props.music === Player.music ? Player.pause() : play();
