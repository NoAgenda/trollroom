<template>
	<div id="info" class="window" role="tabpanel" aria-label="Info">
		<Player />
		<div class="header">
			<SidebarToggle />
		</div>
		<div class="container">
			...
			<h2 class="help-version-title">
				<span>About No Agenda Stream</span>
			</h2>
			...
			<p>
				<a
					href="https://playlist.noagendastream.com/"
					target="_blank"
					rel="noopener"
					class="website-link"
				>Stream Playlist</a>
			...
			<p>
				<a
					href="https://listen.noagendastream.com/"
					target="_blank"
					rel="noopener"
					class="website-link"
				>Direct Link</a>
