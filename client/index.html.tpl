		...
		<div id="loading">
			<div class="window">
				<div id="loading-status-container">
					<img src="img/noagenda-logo.svg" class="logo" alt="" width="256" height="256">
					<img src="img/noagenda-logo.svg" class="logo-inverted" alt="" width="256" height="256">
					<p id="loading-page-message">Troll Room requires a modern browser with JavaScript enabled.</p>
				</div>
